...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            // If activePlayer is set to 'X', the x.png is placed in HTML
        ...
        if(activePlayer === 'O') {
            ...
            disableClick();
            // This function waits 1 seconds before computer places image and enables click
...
function checkWinConditions() {
    ...
    // This function checks if an array includes 3 strings. It's used to
...
// This function makes our body element temporaryily clickable
