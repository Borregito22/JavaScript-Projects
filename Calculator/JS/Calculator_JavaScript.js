...
function Input_Digit(digit) {
    ...
    // We're checking to see if Wait_Second_Operand is true and set
...
function Handle_Operator(Next_Operator) {
    ...
    // displayed on the screen to a number and tehn store the result in
...
keys.addEventListener('click', (event) => {
    ...
    // that was clicked
    const { target } = event;
    // If the element that was clicked on isn't a button, exit the function
